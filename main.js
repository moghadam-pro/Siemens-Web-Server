        ...
        for (const key of Object.keys(records)){
            if (records[key].alpha == item){
                ...
                <div class="cardBox" id="A${item}B${records[key].beta}">
                    ...
                    <div class="cardVal">
                        <span class="angle afterStyle degreeSign beforeStyle panelAngle" title="PANEL ANGEL">${records[key].panelAngel}</span>
                        <span class="wind_velocity afterStyle kmhSign beforeStyle windVelocity" title="WIND VELOCITY">${records[key].windVelocity}</span>
                    </div>
